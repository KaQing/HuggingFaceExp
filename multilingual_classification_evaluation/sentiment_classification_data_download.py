...
train_df.to_csv("train_multilingual_sentiment.csv", index=False)
...
val_df.to_csv("val_multilingual_sentiment.csv", index=False)
...
test_df.to_csv("test_multilingual_sentiment.csv", index=False)
